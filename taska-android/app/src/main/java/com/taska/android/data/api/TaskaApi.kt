...
interface TaskaApi {
  ...
  @GET("/projects") suspend fun getProjects(): List<ProjectDto>
  ...
  @POST("/tasks") suspend fun createTask(@Body request: TaskCreateRequest): TaskDto
  ...
  @GET("/labels") suspend fun getLabels(): List<LabelDto>

  @POST("/register-device") suspend fun registerDevice(@Body request: RegisterDeviceRequest)
}
