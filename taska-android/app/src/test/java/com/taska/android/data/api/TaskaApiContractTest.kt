...
class TaskaApiContractTest {
    ...
    fun taskQueriesUseBackendParameterNames() {
        val method = TaskaApi::class.java.getDeclaredMethod(
            "getTasks",
            String::class.java,
    ...
    fun occurrenceAndDeletePathsMatchBackendTemplates() {
        val followingMethod = TaskaApi::class.java.declaredMethods.single {
            it.name == "updateFollowingTask"
        }
        val occurrenceMethod = TaskaApi::class.java.declaredMethods.single {
            it.name == "updateOccurrence"
        }
        val deleteMethod = TaskaApi::class.java.declaredMethods.single {
            it.name == "deleteTask"
        }
