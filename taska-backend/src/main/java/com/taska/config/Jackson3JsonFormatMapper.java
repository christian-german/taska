...
/**
 * Hibernate's built-in JSON mapper uses Jackson 2. This adapter persists the application's Jackson
 * 3 ({@code tools.jackson.*}) JSON types instead. This is used in the Spring Configuration.
 */
