...
public class TaskaProperties {
  ...
  public static class Security {
    /**
     * Indicates whether JWT timeout should be increased by 10 seconds. Spring security by default
     * sets the timeout to 500ms, which is too short for some OIDC servers.
     */
    private boolean increaseTimeout = false;

    /**
     * Indicates whether issuer validation should be disabled. This is useful when the issuer URI is
