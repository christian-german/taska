...
public class CommentController {
  ...
  public CommentDto create(@Valid @RequestBody CommentCreateRequest commentCreateRequest) {
    CommentCreateParameters commentCreateParameters =
        commentMapper.toParameters(commentCreateRequest);
  ...
  public CommentDto update(
      @PathVariable UUID commentId, @Valid @RequestBody CommentUpdateRequest commentUpdateRequest) {
    CommentUpdateParameters commentUpdateParameters =
        commentMapper.toParameters(commentUpdateRequest);
