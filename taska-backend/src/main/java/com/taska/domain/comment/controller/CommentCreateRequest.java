...
/**
 * Request payload for creating a comment. Exactly one of {@code taskId} or {@code projectId}
 * should be provided to associate the comment with the correct entity.
 *
