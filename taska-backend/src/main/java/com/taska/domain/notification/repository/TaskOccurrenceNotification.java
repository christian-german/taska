 ...
 *
 * <p>This entity deliberately lives outside {@code TaskOccurrenceState}: sending a notification
 * must not materialize a virtual occurrence or alter its business state.
 */
@Entity
