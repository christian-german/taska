...
import com.taska.domain.project.controller.ProjectDto;
import com.taska.domain.project.controller.ProjectMapper;
    ...
    return McpToolResponses.execute(
        () -> {
          ...
          return projectMapper.toDto(
              projectService.create(projectMcpMapper.toParameters(projectCreateInput)));
        });
  }
    ...
    return McpToolResponses.execute(
        () -> {
          ...
          ProjectUpdateParameters projectUpdateParameters =
              projectMcpMapper.toParameters(projectUpdateInput, existingProject);
