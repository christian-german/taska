 ...
 *                    no occurrences are generated from {@code scheduledAt} onwards
 * @param scheduledAt the UTC instant of the recurring occurrence to act on; required when
 *                    {@code scope} is set
 */
public record TaskDeleteRequest(RecurrenceScope scope, Instant scheduledAt) {}
