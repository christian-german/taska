...
public class TaskController {
    ...
    public TaskDto update(
        ...
        return taskMapper.toDto(taskMutationService.replace(
                taskId, taskUpdateParameters, jwt.getSubject()));
    }
    ...
    public TaskDto replaceFollowing(
            ...
            @AuthenticationPrincipal Jwt jwt) {
        TaskUpdateParameters taskUpdateParameters = taskMapper.toParameters(taskUpdateRequest);
        return taskMapper.toDto(taskMutationService.replaceFollowing(
    ...
    public TaskDto replaceOccurrence(
        ...
        return taskMapper.toDto(taskMutationService.replaceOccurrence(
    ...
    public void delete(@PathVariable UUID taskId,
                       ...
                       @AuthenticationPrincipal Jwt jwt) {
        TaskDeleteParameters taskDeleteParameters = taskDeleteRequest == null
                ? null
                : taskMapper.toParameters(taskDeleteRequest);
    ...
    public TaskDto close(@PathVariable UUID taskId,
                         ...
                         @AuthenticationPrincipal Jwt jwt) {
        TaskCloseReopenParameters taskCloseReopenParameters = taskCloseReopenRequest == null
                ? null
                : taskMapper.toParameters(taskCloseReopenRequest);
        return taskMapper.toDto(taskMutationService.close(
                taskId, taskCloseReopenParameters, jwt.getSubject()));
    }
    ...
    public TaskDto reopen(@PathVariable UUID taskId,
        ...
        TaskCloseReopenParameters taskCloseReopenParameters = taskCloseReopenRequest == null
                ? null
                : taskMapper.toParameters(taskCloseReopenRequest);
        return taskMapper.toDto(taskMutationService.reopen(
                taskId, taskCloseReopenParameters, jwt.getSubject()));
    }
