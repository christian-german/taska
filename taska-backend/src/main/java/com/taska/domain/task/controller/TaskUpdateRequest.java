...
public record TaskUpdateRequest(
    ...
    @JsonProperty(required = true) @NotNull List<String> labels,
    @JsonProperty(required = true) Instant scheduledAt,
    @JsonProperty(required = true) Instant dueAt,
    @JsonProperty(required = true) @NotNull Boolean allDay,
    @JsonProperty(required = true) @NotNull Boolean isRecurring,
    @JsonProperty(required = true) Integer estimateMinutes,
    @JsonProperty(required = true) String mentionContext,
