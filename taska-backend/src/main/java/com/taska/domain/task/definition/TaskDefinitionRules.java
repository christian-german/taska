...
public final class TaskDefinitionRules {
  ...
  /**
   * Converts supported recurrence aliases to the canonical RRULE form used by stored definitions.
   * Unknown values are retained so the recurrence parser remains the authority on RRULE syntax.
   *
  ...
  public static String normalizeRecurrenceRule(String recurrenceRule) {
    if (recurrenceRule == null
        ...
        || recurrenceRule.toUpperCase().startsWith("FREQ=")) {
