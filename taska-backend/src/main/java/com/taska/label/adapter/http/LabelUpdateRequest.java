 ...
 */
public record LabelUpdateRequest(@JsonProperty(required = true) @NotBlank String name, @JsonProperty(required = true) @NotNull String color,
        @JsonProperty(required = true) @NotNull Integer order, @JsonProperty(required = true) @NotNull Boolean isFavorite) {
}
