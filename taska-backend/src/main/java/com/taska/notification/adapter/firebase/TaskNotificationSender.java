package com.taska.notification.adapter.firebase;
...
public class TaskNotificationSender {
     ...
     *
     * <p>
     * Recurring payloads include their stable occurrence identity so clients can distinguish the notified occurrence from its backing series.
     *
