...
import com.taska.notification.application.DeviceRegistrationService;
...
public class RegisterDeviceController {
    ...
    /**
     * Registers a device token for push notifications. If the token already exists, it is upserted rather than duplicated. Returns HTTP 200 on
     * success.
     *
