...
public class TaskOccurrenceNotificationService {
    ...
    public boolean claim(UUID seriesId, Instant occurrenceScheduledAt) {
        return taskOccurrenceNotificationRepository.claim(UUID.randomUUID(), seriesId, occurrenceScheduledAt, Instant.now()) == 1;
    }
    ...
    public void clear(UUID seriesId, Instant occurrenceScheduledAt) {
        taskOccurrenceNotificationRepository.deleteBySeriesIdAndOccurrenceScheduledAt(seriesId, occurrenceScheduledAt);
    }
}
