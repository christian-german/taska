...
public interface DeviceTokenRepository extends JpaRepository<DeviceToken, UUID> {
    ...
    /**
     * Looks up a device token by its FCM token string. Used during device registration to determine whether to insert a new record or update the
     * timestamps of an existing one (upsert pattern).
     */
