...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles Bean Validation failures and returns a 400 Problem Detail response with a map of field names to their validation error messages.
     *
    ...
    /**
     * Catch-all handler for unexpected exceptions. Logs the full stack trace and returns a 500 Problem Detail to avoid leaking internal error details
     * to clients.
     *
