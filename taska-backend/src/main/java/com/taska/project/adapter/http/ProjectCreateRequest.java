 ...
 * @param parentId UUID of the parent project to nest this project under; {@code null} keeps the project at root level on creation
 ...
 * @param viewStyle preferred rendering mode ({@code LIST}, {@code BOARD}, or {@code CALENDAR}); defaults to {@code LIST} on create
 */
public record ProjectCreateRequest(@NotBlank String name, String color, UUID parentId, Integer order, Boolean isFavorite, ViewStyle viewStyle,
