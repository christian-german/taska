...
import com.taska.dto.FilterRequest;
import com.taska.dto.FilterResponse;
import com.taska.dto.TaskResponse;
import com.taska.exception.ResourceNotFoundException;
import com.taska.model.Filter;
import com.taska.repository.FilterRepository;
...
public class FilterService {
    ...
    public FilterResponse update(UUID id, FilterRequest req) {
        ...
        // hasDate can be explicitly set to null (no filter), true or false
