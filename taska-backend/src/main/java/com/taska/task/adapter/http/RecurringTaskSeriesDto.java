...
public record RecurringTaskSeriesDto(UUID id, String content, String description, UUID projectId, UUID parentId, Integer order, Integer priority,
        List<String> labels, Instant scheduledAt, Boolean allDay, Integer estimateMinutes, String mentionContext, Instant createdAt,
        Instant updatedAt, TaskType type, String recurrenceRule, Instant rruleEndsAt) implements TaskDto {
