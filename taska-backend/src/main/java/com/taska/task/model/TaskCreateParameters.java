...
public record TaskCreateParameters(String content, String description, UUID projectId, UUID parentId, int position, Integer priority,
        ...
        String recurrenceRule, TaskType type) {
}
