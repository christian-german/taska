...
import com.taska.domain.notification.service.TaskNotificationCandidate;
import com.taska.domain.notification.service.TaskNotificationCandidateService;
import com.taska.domain.notification.service.TaskNotificationScheduler;
import com.taska.domain.notification.service.TaskNotificationSender;
...
class TaskNotificationSchedulerTest {
  ...
  @Mock private TaskNotificationCandidateService candidateService;
  @Mock private TaskOccurrenceNotificationService occurrenceNotificationService;
  @Mock private TaskNotificationSender notificationSender;
  @Mock private TaskRepository taskRepository;
  @Mock private DeviceTokenRepository deviceTokenRepository;
  @InjectMocks private TaskNotificationScheduler scheduler;
  ...
  void recurringOccurrenceIsDispatchedOnceToEveryTokenAfterWinningItsClaim() {
    ...
    when(occurrenceNotificationService.claim(candidate.taskId(), candidate.occurrenceScheduledAt()))
        .thenReturn(true);
  ...
  private TaskNotificationCandidate recurringCandidate() {
    ...
    return TaskNotificationCandidate.recurring(
