...
class LabelServiceTest {
    ...
    void create_appliesEveryApplicationParameter() {
        LabelCreateParameters labelCreateParameters = new LabelCreateParameters("Work", "blue", 3, true);
        when(labelRepository.save(org.mockito.ArgumentMatchers.any(Label.class))).thenAnswer(invocation -> invocation.getArgument(0));
