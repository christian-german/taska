...
import com.taska.project.adapter.mcp.ProjectMcpTools;
import com.taska.project.application.ProjectService;
import com.taska.task.adapter.mcp.TaskMcpMapperImpl;
import com.taska.task.adapter.mcp.TaskMcpTools;
...
@SpringBootTest(classes = McpEndpointIntegrationTest.TestApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        "spring.autoconfigure.exclude=" + "org.springframework.boot.jdbc.autoconfigure.DataSourceAutoConfiguration,"
                + "org.springframework.boot.hibernate.autoconfigure.HibernateJpaAutoConfiguration,"
                + "org.springframework.boot.flyway.autoconfigure.FlywayAutoConfiguration",
        "spring.ai.mcp.server.protocol=STATELESS", "spring.ai.mcp.server.streamable-http.mcp-endpoint=/mcp",
