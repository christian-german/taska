...
final class TaskMutationFixtures {
    ...
    static TaskOccurrenceState buildOccurrenceState(UUID seriesId, Instant occurrenceScheduledAt, TaskOccurrenceStatus status) {
     ...
     */
    static TaskPatchParameters taskRequest(String content, RecurrenceScope scope, Instant occurrenceScheduledAt) {
    ...
    static TaskPatchParameters taskRequest(String content, Integer priority, RecurrenceScope scope, Instant occurrenceScheduledAt) {
        return new TaskPatchParameters(
                content,
                null,
                null,
    ...
    @SuppressWarnings("SameParameterValue")
    static TaskPatchParameters reqWithScheduledAt(Instant scheduledAt, RecurrenceScope scope, Instant occurrenceScheduledAt) {
        return new TaskPatchParameters(
                null,
                null,
                null,
    ...
    @SuppressWarnings("SameParameterValue")
    static TaskPatchParameters reqWithRRule(String content, String recurrenceRule, RecurrenceScope scope, Instant occurrenceScheduledAt) {
        return new TaskPatchParameters(
                content,
                null,
                null,
    ...
    static TaskCreateParameters createParameters(String content, TaskType type) {
        return new TaskCreateParameters(content, null, null, null, 0, null, null, null, null, false, false, null, null, null, type);
    }
    ...
    static TaskPatchParameters recurringPatch(Instant dueAt) {
        return new TaskPatchParameters(null, null, null, null, null, null, null, null, dueAt, null, true, null, null, "FREQ=DAILY", null, null, null);
    }
}
