...
@Component({
  ...
  imports: [TaskItemComponent, TaskDetailComponent, AddTaskFormComponent],
  template: `
    <div class="h-full flex flex-col overflow-hidden">

      <!-- Header -->
      <div class="px-8 py-5 border-b border-gray-100 dark:border-gray-800 flex items-center gap-3 flex-shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-purple-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div class="flex-1 overflow-auto">
        <div class="max-w-2xl mx-auto px-8 py-6">
          ...
          <app-add-task-form (taskCreated)="onTaskCreated($event)" />
        </div>
      </div>
    </div>
